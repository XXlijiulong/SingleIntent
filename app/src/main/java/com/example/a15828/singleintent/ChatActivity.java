...
import com.example.a15828.singleintent.adapter.ChatMessageAdapter;
import com.example.a15828.singleintent.pojo.ChatMessage;
import com.example.a15828.singleintent.util.HttpUtils;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initData() {
        ...
        list.add(new ChatMessage("您好,小星为您服务!", ChatMessage.Type.INCOUNT));
