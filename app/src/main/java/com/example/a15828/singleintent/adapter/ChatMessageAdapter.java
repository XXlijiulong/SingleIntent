...
import com.example.a15828.singleintent.pojo.ChatMessage;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (getItemViewType(position) == 0) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_chat_left_item, null);
                ...
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_chat_right_item, null);
                viewHolder = new ViewHolder();
